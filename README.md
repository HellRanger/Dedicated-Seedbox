...
## Usage
### Install.sh
`bash <(wget -qO- https://raw.githubusercontent.com/hellranger/Dedicated-Seedbox/main/Install.sh) <username> <password> <Cache Size(unit:GiB)>`

### Tune.sh if you have already installed clients (Likely to break something, becareful)

`bash <(wget -qO- https://raw.githubusercontent.com/hellranger/Dedicated-Seedbox/main/Tune.sh)`
