...
source <(wget -qO- https://raw.githubusercontent.com/hellranger/Seedbox-Components/main/seedbox_installation.sh)
Update
...
source <(wget -qO- https://raw.githubusercontent.com/hellranger/Seedbox-Components/main/Miscellaneous/boot-script.sh)
boot_script
tput sgr0; clear
